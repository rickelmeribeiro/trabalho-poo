...
<head>
    ...
    <title>DEFINIÇÃO E EXEMPLOS</title>
...
<div class="container-fluid" style="margin-left: 11%">
    ...
    <div class="card mt-1 mb-3" style="border: 3px solid black">
        ...
        <img src="./img/Captura%20de%20tela%202024-06-03%20142403.png" style="width: 50%;margin-left: 26%"
             class="card-img-top d-flex rounded-2" alt="...">
        <div class="card-body">
            <p style="font-weight: bold">Um objeto, na programação orientada a objetos (POO), é uma instância de uma classe. Uma classe é um
            ...
            <p style="font-weight: bold">Quando você cria um objeto a partir de uma classe, está essencialmente criando uma variável que pode
            ...
            <p style="font-weight: bold">Por exemplo, considere uma classe Carro. Esta classe pode ter atributos como cor, modelo, ano, etc., e
            ...
            <p style="font-weight: bold">Em resumo, um objeto é uma instância específica de uma classe que tem seus próprios dados e
    ...
    <div class="card mt-1 mb-3" style="border: 3px solid black">
        ...
        <div class="card-body">
            <p style="font-weight: bold">As propriedades são basicamente características do objeto. </p>
            <p style="font-weight: bold">São definições como: "Cor de pele", "Cor dos olhos" e etc...</p>
        </div>
    </div>
    <!---->
    <!---->
    <div class="card mt-1 mb-3" style="border: 3px solid black">
        ...
        <div class="card-body">
            <p style="font-weight: bold">Os métodos são as ações do objeto.</p>
            <p style="font-weight: bold">Os métodos definem as ações de objetos como: O Objeto "Cachorro" tem o métodos "latir()", onde se for
                "true", ele late e se for "false", ele não late.</p>
            <p style="font-weight: bold">No exemplo acima temos como objeto: "Caneta" e como método: "rabiscar()", mas temos uma condição, onde o
    ...
    <div class="card mt-1 mb-3" style="border: 3px solid black">
        ...
        <div class="card-body">
            <p style="font-weight: bold">O encapsulamento é uma das principais técnicas que define a programação orientada a objetos. Se
            ...
            <p style="font-weight: bold">A maior parte das linguagens orientadas a objetos implementam o encapsulamento baseado em propriedades
            ...
            <p style="font-weight: bold">Para fazermos um paralelo com o que vemos no mundo real, temos o encapsulamento em outros elementos. Por
    ...
    <div class="card mt-1 mb-3" style="border: 3px solid black">
        ...
        <div class="card-body">
            <p style="font-weight: bold">O reuso de código é uma das grandes vantagens da programação orientada a objetos. Muito disso se dá por
                uma questão que é conhecida como herança. Essa característica otimiza a produção da aplicação em tempo e
                linhas de código.</p>
            <p style="font-weight: bold">Para entendermos essa característica, vamos imaginar uma família: a criança, por exemplo, está herdando
            ...
            <p style="font-weight: bold">Os métodos privados de uma classe pai não são acessíveis a uma classe filha. Como resultado, as classes
    ...
    <div class="card mt-1 mb-3" style="border: 3px solid black">
        ...
        <div class="card-body">
            <p style="font-weight: bold">Outro ponto essencial na programação orientada a objetos é o chamado polimorfismo. Na natureza, vemos
            ...
            <p style="font-weight: bold">Como um exemplo, temos um objeto genérico “Eletrodoméstico”. Esse objeto possui um método, ou ação,
            ...
            <p style="font-weight: bold">Com relação ao polimorfismo, valem algumas observações. Como se trata de um assunto que está intimamente
            ...
            <p style="font-weight: bold">Esses quatro pilares são essenciais no entendimento de qualquer linguagem orientada a objetos e da
    ...
    <!--    -->
    <div class="card mt-1 mb-3" style="border: 3px solid black">
        <h1 class="text-center">ABSTRAÇÃO E CLASSE ABSTRATA</h1>
        <div class="row">
            <div class="col-3">
                <img src="./img/abstracao.png" class="ms-2" alt="">
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col-3">
                <img src="./img/abstracaoresultado.png" class="ms-2" style="width: 200%" alt="">
            </div>
        </div>
        <div class="card-body">
            <p style="font-weight: bold">Classes abstratas são especiais porque elas nunca podem ser instanciadas. Ao invés disso, obriga o
                desenvolvedor a herda-la como um conjunto de propriedades e métodos base para a nova classe. Por este
                motivo, elas são classes que são comumente usadas como classes-base.</p>
        </div>
    </div>
    <!--    -->
    <!--    -->
    <div class="card mt-1 mb-3" style="border: 3px solid black">
        <h1 class="text-center">GET E SET</h1>
        <img src="./img/getset.png" class="ms-2" style="width: 98%" alt="">
        <div class="card-body">
            <p style="font-weight: bold">GET e SET são basicamente criar e mostrar, o SET você usa para setar alguma coisa, por exemplo saldo, no
                saldo se usa SET para definir quanto dinheiro eu possuo, já o GET você usa para mostrar o saldo.</p>
        </div>
    </div>
    <!--    -->
    <!--    -->
    <div class="card mt-1 mb-3" style="border: 3px solid black">
        <h1 class="text-center">ASSOCIAÇÃO</h1>
        <div class="row"><div class="col-3"><img src="./img/associacao.png" class="ms-2" alt=""></div></div>
        <br>
        <div class="row"><div class="col-3"><img src="./img/assosciaresultado.png" class="ms-2" style="width: 300%" alt=""></div></div>
        <div class="card-body">
            <p style="font-weight: bold">É uma das relações mais comuns entre dois objetos, acontece quando um objeto "utiliza" outro, porém, sem
                que eles dependam um do outro. Em outras palavras, é como se eu tivesse duas classes distintas, e
                fizesse uso de uma delas dentro da outra, ou como parâmetro de outra.</p>
        </div>
    </div>
    <!--    -->
    <!--    -->
    <div class="card mt-1 mb-3" style="border: 3px solid black">
        <h1 class="text-center">AGREGAÇÃO</h1>
        <div class="row"><div class="col-3"><img src="./img/agregacao.png" class="ms-2" alt=""></div></div>
        <br>
        <div class="row"><div class="col-3"><img src="./img/agregacaoresultado.png" class="ms-2" style="width: 300%" alt=""></div></div>
        <div class="card-body">
            <p style="font-weight: bold">Acontece quando um objeto precisa de outro objeto para completar a sua
                ação (Todo/Parte), ou seja, faz a agregação de um objeto externo e o utiliza como parte de si própria.
                Um
                exemplo muito falado sobre esse tipo de relação é quanto ao carrinho de compras e seus produtos. A
                classe
                carrinho de compras (Todo) precisa da classe produtos (Parte) para executar suas ações.</p>
        </div>
    </div>
    <!--    -->
    <!--    -->
    <div class="card mt-1 mb-3" style="border: 3px solid black">
        <h1 class="text-center">DEPENDÊNCIA</h1>
        <div class="row">
            <div class="col-3">
                <img src="./img/dependencia.png" class="ms-2" alt="">
            </div>
        </div>
        <br>
        <div class="row">
            <div class="col-3">
                <img src="./img/dependenciaresultado.png" class="ms-2" style="width: 200%" alt="">
            </div>
        </div>
        <div class="card-body">
            <p style="font-weight: bold">Refere-se ao relacionamento entre classes, onde uma classe necessita de outra para funcionar
                corretamente.</p>

                <p style="font-weight: bold">No contexto de Programação Orientada a Objetos (POO) em PHP, dependências ocorrem quando uma classe
                (consumidora) utiliza outra classe (fornecedora) para completar suas tarefas. Esta relação é fundamental
                para modularização e reusabilidade do código. Por exemplo, se uma classe Carro depende de uma classe
                Motor para funcionar, o Carro terá uma dependência em Motor.</p>

               <p style="font-weight: bold">Para gerenciar essas dependências de forma eficiente e manter o código limpo e flexível, utilizamos
                técnicas como injeção de dependências (Dependency Injection, DI). DI permite que as dependências sejam
                passadas para a classe consumidora através do construtor, de um método setter, ou diretamente por
                propriedade.</p>
        </div>
    </div>
    <!--CONTAINER-->
